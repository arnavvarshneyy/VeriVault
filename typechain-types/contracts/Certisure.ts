...
export interface CertisureInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "ISSUER_ROLE"
  ...
  decodeFunctionResult(functionFragment: "fileHashOf", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "getApproved",
    data: BytesLike
  ): Result;
...
export interface Certisure extends BaseContract {
  connect(runner?: ContractRunner | null): Certisure;
  waitForDeployment(): Promise<this>;

  interface: CertisureInterface;
  ...
  fileHashOf: TypedContractMethod<[tokenId: BigNumberish], [string], "view">;
  ...
  mintCertificate: TypedContractMethod<
    [to: AddressLike, tokenUri: string, fileHash: BytesLike],
    [bigint],
    "nonpayable"
  >;
  ...
  filters: {
    ...
    "CertificateMinted(uint256,address,address,string,bytes32)": TypedContractEvent<
      CertificateMintedEvent.InputTuple,
      CertificateMintedEvent.OutputTuple,
      CertificateMintedEvent.OutputObject
    >;
